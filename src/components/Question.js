	...
	return (
		<div className="h-screen">
			...
			<div className="flex flex-col h-5/6 items-center justify-center text-5xl m-auto">
				...
				<h1 className={`bg-emerald-600 text-white hover:bg-blue-600 font-bold w-full text-center px-8 py-6 mt-auto ${answerVisible ? '' : 'invisible'}`}>{currentQuestion.answer}</h1>
