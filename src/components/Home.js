...
const Home = () => {
	return (
		<div className="h-screen flex flex-col">
			...
			<Link to="/rounds" className="bg-emerald-600 text-white mx-auto mb-48 px-8 py-4 rounded-l text-2xl hover:bg-button-hover-color transition-colors">Let's Start</Link>
		</div>
	);
}
